...
from forecastic.schema import GenerativeDeploymentSettings
...
custom_model_args = CustomModelArgs(
    resource_name=f"Forecasting Assistant Proxy LLM Custom Model [{project_name}]",
...
registered_model_args = RegisteredModelArgs(
    resource_name=f"Forecasting Assistant Proxy LLM Registered Model [{project_name}]",
)


deployment_args = DeploymentArgs(
    resource_name=f"Forecasting Assistant Proxy LLM Deployment [{project_name}]",
    label=f"Forecasting Assistant Proxy LLM Deployment [{project_name}]",
